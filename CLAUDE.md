...
`list_parts`, `get_part`, `search_parts`, `create_part`, `update_part`, `delete_parts`, `list_stock_items`, `get_stock_item`, `adjust_stock`, `transfer_stock`, `stock_by_category_and_location`, `stock_pivot`, `list_locations`, `get_location`, `get_location_tree`, `list_categories`, `get_category`, `get_category_tree`, `list_purchase_orders`, `get_purchase_order`, `list_sales_orders`, `get_sales_order`, `list_bom_items`, `get_bom_for_part`, `list_build_orders`, `get_build_order`, `list_tags`, `search_tags`
